...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <form method="post" action="./updateDate">
  <tr>
	...
	%>
      ...
      <tr>
        <td height="45" colspan="3" bgcolor="#CCCCCC" class="judul">Tanggal Event yang pilih </td>
        </tr>
      <tr>
        <td height="22" colspan="3" class="judul"><div align="center" class="war"><%
	...
	%></div></td>
      ...
      <tr>
        <td width="89" height="29">List Date </td>
        <td width="5">:</td>
		 <input type="hidden" name="idBooking" value="<%=idBooking%>" />
        <td width="189"><select name="date" id="date">
          <option value="">--Pilih Salah Satu --</option>
			<%
			int i;
			for (i=1;i<=31;i++)//melakukan loop untuk tanggal
			{
			%>
      ...
      <tr>
        ...
        <td><select name="month" id="month">
		 <option value="">--Pilih Salah Satu --</option>
		<%
			for (i=1;i<=12;i++)//melakukan loop untuk bulan
			{
		%>
      ...
      <tr>
        ...
        <td><select name="year" id="year">
		 <option value="">--Pilih Salah Satu --</option>
			<%
			for (i=2009;i<=2030;i++)//melakukan loop untuk tahun
			{
			%>
		 <option value="<%=i%>"><%=i%></option>
		 	<%
      ...
      <tr>
        ...
        <td>&nbsp;</td>
        <td><div align="right">
          <input name="Save" type="submit" id="" value="S a v e" />
		  <input name="cancel" type="submit" id="" value="c a n c e l" />
        </div></td>
      </tr>
    </table>
	<%
