...
String admin = (String) session.getAttribute("admin");
	...
	database db = new database(application.getRealPath("WEB-INF/db.mdb")); //merupakan fungsi been db
	if(db.cekLogin(user,pass))//digunakan untuk melakukan cekLogin
	{
	
	String[] dat = new String[12];//merupakan fungsi service untuk memuncurkan service yang ada menurut idBooking
dat[0] = "Januari";
dat[1] = "Febuari";
dat[2] = "Maret";
dat[3] = "April";
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="57" colspan="2" ><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="41" colspan="3" bgcolor="#CCCCCC" class="judul">Masukan Jumlah Tampilan Page </td>
        </tr>
      <tr>
        <td height="28" colspan="3"><span class="war">
          <%
			String error = request.getParameter("error");//mendapatkan parameter error
	...
	%>
      ...
      <tr>
        <td width="44%" height="36">Jumlah Page yang ingin di Tampilkan </td>
        <td width="1%">:</td>
        <td width="55%"><input name="num" type="text" id="num" /></td>
      </tr>
      <tr>
