...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	{
	%>
        <form method="post" action="actionPage.jsp">
          <table width="427" height="167" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="31" colspan="3" bgcolor="#CCCCCC"><div align="right" class="judul">
                  <div align="center">Pencarian Data Transaksi </div>
              </div></td>
            </tr>
            <tr>
              <td width="116" height="37">Username</td>
              <td width="14">:</td>
              <td width="297"><input name="user" type="text" id="user" /></td>
            </tr>
            <tr>
              <td height="15">Event</td>
              <td width="14">:</td>
		  ...
		  %>
            ...
            <tr>
              ...
              <td width="297"><select name="tanggal" id="tanggal">
				...
				ArrayList booking = db.viewBooking("select * from ms_header_Booking a, ms_login b where a.idUser = b.idUser ");
				Iterator iterator3 = booking.iterator();
				
				
				while(iterator3.hasNext()) 
				{
					HeaderBooking bkg= (HeaderBooking) iterator3.next(); // memanggil been heaerBooking
		  ...
		  %>
            ...
            <tr>
              ...
              <td><select name="team" id="team">
				...
				ArrayList team = db.viewTeam("select * from ms_team ");
				Iterator iterator1 = team.iterator(); //memajukan data pada array selanjutnya pada arraylist team
